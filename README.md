...
release a new version, update the version number in `berns.rb`, and then run
...
https://github.com/taylorbeck/berns. This project is intended to be a safe,
...
conduct](https://github.com/[USERNAME]/berns/blob/master/CODE_OF_CONDUCT.md).
